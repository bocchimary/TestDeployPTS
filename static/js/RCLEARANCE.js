...
function toggleSidebar() {
    ...
    const mainContent = document.querySelector('.registrar_clearance_main-content');
...
function addResetFiltersButton() {
    ...
    const filterContainer = document.querySelector('.d-flex.flex-wrap.gap-3.align-items-center');
    if (filterContainer) {
        // Create reset button
        const resetButton = document.createElement('button');
        resetButton.type = 'button';
        resetButton.className = 'btn btn-outline-secondary btn-sm';
        resetButton.innerHTML = '<i class="bi bi-arrow-clockwise"></i> Reset Filters';
