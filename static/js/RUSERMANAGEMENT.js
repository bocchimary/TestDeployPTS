...
function showAdminPanel(user) {
    ...
    document.getElementById("registrar_user_manager_adminStatus").textContent = user.status;
    document.getElementById("registrar_user_manager_adminStatus").className = `user-status ${user.status === 'Active' ? 'active-status' : 'inactive-status'}`;
    ...
    document.getElementById("registrar_user_manager_adminEmailDetail").textContent = user.email || '-';
...
function showStudentPanel(user) {
    ...
    document.getElementById("registrar_user_manager_studentEmail").textContent = user.email || '-';
    ...
    document.getElementById("registrar_user_manager_studentRole").textContent = user.user_type_display;
    document.getElementById("registrar_user_manager_studentUsername").textContent = user.username;
    document.getElementById("registrar_user_manager_studentCourse").textContent = user.course || '-';
    document.getElementById("registrar_user_manager_studentYear").textContent = user.year || '-';
